  ...
  return (
    <>
      ...
      <section className="flex items-start justify-between">
        ...
        <div className="border-2 border-black  h-100 mx-4 w-full  mt-6 rounded-3xl p-4 flex flex-col items-center justify-center w-full">
          ...
          <div className="flex justify-between items-start gap-4 mt-4 w-full h-full ">
            ...
            <div className="border-2 rounded-3xl p-6 shadow-3xl px-16 h-96">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div>
                  <p className="px-4 py-2 border-2 rounded-2xl p-4 m-4 ">
                    element
                  </p>
                  <p className="px-4 py-2 border-2 rounded-2xl p-4 m-4 ">
                    element
