...
const Grade = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center gap-8 py-12">
      <h1 className="text-4xl mt-4 text-center">{t("select")}</h1>
      <button
      ...
      <button
        className="md:text-3xl  text-xluppercase background px-8 py-3 cursor-pointer rounded-tl-md rounded-tr-md rounded-br-3xl rounded-bl-md hover:scale-105 cursor-pointer duration-200 w-4/5"
