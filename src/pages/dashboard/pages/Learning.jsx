...
const Learning = () => {
  ...
  return (
    ...
    <div className="flex justify-end w-full">
        <h1 className="text-3xl mr-4 uppercase background border-black border-2 px-2 py-5 cursor-pointer rounded-full ">{state.grade} AS</h1>
      </div>
    <section>
      ...
      <button className="px-28 py-6 rounded-lg background hover:scale-105 duration-200">
        <h1 onClick={()=>{
        navigate("/dashboard/learning-exc",{state:{grade:state.grade}})
